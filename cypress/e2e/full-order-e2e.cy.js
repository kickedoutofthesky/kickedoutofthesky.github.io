...
const ORDER_MANIFEST = [
  ...
  // Hats (4 products)
  {
    productKey: "product_421115406",
    title: "Snapback Hat w/ Embroidery Star Logo",
    color: "Black",
    size: "One Size",
    quantity: 1,
    priceCents: 2500,
    variantId: 5209549705,
  },
  {
  ...
  {
    productKey: "product_424594773",
    title: "Unisex Long Sleeve Tee w/ Star Logo",
    color: "Black",
    size: "M",
    quantity: 1,
    priceCents: 3500,
    variantId: 5238968909,
  },
  {
    productKey: "product_424594667",
    title: "Unisex Long Sleeve Tee w/ Text",
    color: "Dark Grey Heather",
    size: "XL",
    quantity: 1,
    priceCents: 3500,
    variantId: 5238968307,
  },
  {
    productKey: "product_421297848",
    title: "Unisex Long Sleeve Tee w/ Star + Typewriter Text Sleeve",
    color: "Black",
    size: "S",
    quantity: 2,
    priceCents: 4000,
    variantId: 5211363565,
  },
  {
    productKey: "product_421297606",
    title: "Unisex Long Sleeve Tee w/ Typewriter Text",
    color: "Dark Grey Heather",
    size: "L",
    quantity: 1,
    priceCents: 3500,
    variantId: 5211361279,
  },
  // Hoodie (1 product)
  {
